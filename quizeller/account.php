...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Quizeller Team</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Quizeller Team</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Quizeller Team</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 1234567890</h4>
		<h4 style="font-family:'typo' ">quizellerTeam@gmail.com</h4>
		<h4 style="font-family:'typo' ">Quizeller Team,MITM </h4></div></div>
		</p>
      </div>
...
<h4 class="modal-title" style="font-family:'typo' "><span style="color:white">Copyright@2021-21</span></h4>
</body>
</html>
