...
<head>
<link rel="icon" href="favicon.ico" type="image/icon" sizes="10x10">
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="viewport" content="width=device-width, initial-scale=1">

<title> Quizeller  </title>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:darkblue;font-size:12px;font-weight: bold">Login to Student Account</span></h4>
      </div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your University No. (Ex.4MH19IS001***)" class="form-control input-md" type="text" value="<?php
...
?>>Mechanical Engineering</option> 
   <option value="Physics-Cycle" <?php
  if (isset($_GET['branch']))
  {
if ($_GET['branch'] == "PC")
    echo "selected";
...
?>>Physic-Cycle</option> 
    <option value="Chemistry-Cycle" <?php
  if (isset($_GET['branch']))
  {
if ($_GET['branch'] == "CC")
    echo "selected";
  }
?>>Chemistry-Cycle</option> </select>
...
<div class="row footer " style="background-color:brown;">
<div class="col-md-3 box ">
<a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow">Admin Login</a></div>
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Organized by Quizeller Team<br><br></span>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:darkblue;font-size:12px;font-weight: bold">Login to Admin page</span></h4>
      </div>
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Copyright@2021-22<br><br></span>
</div>
</body>
</html>
